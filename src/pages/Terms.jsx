...
const Terms = () => {
    return (
        <>
            <Navbar />
            <h1 className="bg-[#002E87] text-white font-paypal text-center text-[30px] py-5">Terms and Conditions</h1>
            {/* main content */}
            <div className="container px-4 md:px-12 flex flex-col my-20 gap-2">
                ...
                <div className="md:mt-4 space-y-2">
                    <h2 className="text-[#002E87] font-paypal font-bold text-[18px]">Service Description:</h2>
                ...
                <div className="md:mt-4 space-y-2">
                    <h2 className="text-[#002E87] font-paypal font-bold text-[18px]">Customer Responsibilities:</h2>
                    <ul className="list-disc ml-6">
                ...
                <div className="md:mt-4 space-y-2">
                    <h2 className="text-[#002E87] font-paypal font-bold text-[18px]">Payments and Billing:</h2>
                    <ul className="list-disc ml-6">
                ...
                <div className="md:mt-4 space-y-2">
                    <h2 className="text-[#002E87] font-paypal font-bold text-[18px]">Service Availability:</h2>
                    <ul className="list-disc ml-6">
                ...
                <div className="md:mt-4 space-y-2">
                    <h2 className="text-[#002E87] font-paypal font-bold text-[18px]">Privacy and Data Protection:</h2>
                    <ul className="list-disc ml-6">
                ...
                <div className="md:mt-4 space-y-2">
                    <h2 className="text-[#002E87] font-paypal font-bold text-[18px]">Termination:</h2>
                    <ul className="list-disc ml-6">
                ...
                <div className="md:mt-4 space-y-2">
                    <h2 className="text-[#002E87] font-paypal font-bold text-[18px]">Limitation of Liability:</h2>
                    <ul className="list-disc ml-6">
                ...
                <div className="md:mt-4 space-y-2">
                    <h2 className="text-[#002E87] font-paypal font-bold text-[18px]">Governing Law:</h2>
                    <p>These terms and conditions are governed by and construed in accordance with the laws of [Jurisdiction].</p>
                </div>

                <div className="md:mt-4 space-y-2">
                    <h2 className="text-[#002E87] font-paypal font-bold text-[18px]">Changes to Terms and Conditions:</h2>
