...
function About() {
    ...
    return (
        <>
            ...
            {/* provide */}
            <div className="mt-10 container px-5 md:px-0 mx-auto flex flex-col space-y-8 pb-14">
                <div className='flex items-start gap-10'>
                    ...
                    <div className="flex flex-col space-y-3">
                        <p className='text-3xl  text-[#04BD4B]'>Who We Are</p>
                        <p className='text-xl'>We are a leading service provider in Nigeria dedicated to simplifying and enhancing the  process of paying electricity bills for individuals and businesses. With a deep understanding of  the challenges associated with bill payment and a commitment to financial empowerment, we aim to become a trusted partner for thousands of clients across the nation.</p>
                        <p className='text-xl '>Our team is composed of experienced professionals who are passionate about delivering   user-friendly solutions and exceptional customer service. We take pride in our role as a   facilitator of secure and convenient electricity bill payments, empowering our clients to take   control of their energy expenses.</p>
                    </div>
                </div>

                <div className='flex items-start gap-10'>
                    <svg width={75} height={76} className="-mt-2" viewBox="0 0 98 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="flex flex-col space-y-3">
                        <p className='text-3xl  text-[#04BD4B]'>What We Do</p>
                        <p className='text-xl'>We provide comprehensive solutions to  help clients manage and pay their  electricity bills in Nigeria. Our services are designed to simplify the bill payment process, promote financial well-being, and  enhance the overall experience for our  clients.</p>
                    </div>
                </div>

                <div className='flex items-start'>
                    <div className='flex items-start gap-10'>
                        <svg width={75} height={76} className="-mt-2" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="flex flex-col space-y-3">
                            <p className='text-3xl  text-[#04BD4B]'>How We Work</p>
                            <p className='text-xl'>Our commitment to security, convenience, and client empowerment is at the core of how we operate. By offering a user-friendly platform, multiple payment options, and personalized support, we simplify the process of paying electricity {' '}bills.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className='bg-gray-200 pb-24'>
                ...
                <div className='flex flex-col space-y-8 pt-10 px-8 md:px-10'>
                    <div className=''>
                        <p className='text-3xl text-[#04BD4B] '>Customer-centricity</p>
                        <p className='text-xl'>We prioritize our client's needs and continuously seek to enhance their experience by providing user-friendly, customer-centric solutions.</p>
                    </div>
                    <div className=''>
                        <p className='text-3xl text-[#04BD4B] '>Innovation</p>
                        <p className='text-xl'>We embrace innovation to develop cutting-edge technologies and services that make bill payments easier, more efficient and more accessible.</p>

                    </div>
                    <div className=''>
                        <p className='text-3xl text-[#04BD4B] '>Reliability</p>
                        <p className='text-xl'>We are dedicated to providing a reliable platform that our clients can trust fortimely and accurateelectricity bill payments</p>
