        ...
        <>
            ...
            <div className="flex flex-col space-y-8 md:w-4/6 mx-auto px-5 py-20 md:px-0">
                <div className='flex items-start gap-10'>
                    <svg width={110} height={76} className="" viewBox="0 0 100 76" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='flex items-start gap-10'>
                    <svg width={75} height={76} className="" viewBox="0 0 98 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='flex items-start'>
                    <div className='flex items-start gap-10'>
                        <svg width={75} height={76} className="" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
