    ...
    return (
        <div>
            ...
            <div className='px-2 md:px-0 py-20'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-3 gap-4 justify-center px-4 md:px-24'>
                    <div className='mx-2 md:mx-0'>
                        <p className='font-medium text-3xl pt-16 text-[#04BD4B] text-center'>100% Reliable</p>
                        <p className=''>We ensure that your meter token is delivered without fail.</p>
                    </div>

                    <div className='mx-2 md:mx-0'>
                        <p className='font-medium text-3xl pt-16 text-[#04BD4B] text-center'>Easy Access</p>
                        <p className=''>We provide instant access to your historical payments.</p>
                    </div>

                    <div className='mx-2 md:mx-0'>
                        <p className='font-medium text-3xl pt-16 text-[#04BD4B] text-center'>Safe & Secure</p>
            ...
            <div className='bg-gray-200 py-20'>
                ...
                <div className="flex items-center px-4 container justify-center text-center gap-2 md:gap-28 mx-auto">
                    <p className="max-w-[20%]">Login to banking app </p>
                    <div className="max-w-[25%]" />
                    <p className="max-w-[20%]">Select Accuvend</p>
                    <div className="max-w-[25%]" />
                    <p className="max-w-[20%]">Enter meter number</p>
                </div>
            </div>
            <Footer />
        </div>
