        ...
        <div className="bg-[#F3F7F8]">
            <div className='flex items-center w-[80%] mx-auto py-[110px]'>
                <div className=" basis-1/2">
                    <h1 className="text-[70px] font-bold mb-4">Get in touch with us, we will love to hear from you</h1>
                    <div className="gap-2">
                ...
                <div className="basis-1/2">
                    ...
                    <form
                        ...
                        className="max-w-xl mx-auto bg-white p-10 rounded-xl drop-shadow-xl"
                    >
